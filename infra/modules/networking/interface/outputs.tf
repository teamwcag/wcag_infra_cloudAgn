...
output "public_route_table_ids" {
  value = coalesce(
    try(module.aws[0].public_route_table_ids, null),
    try(module.azure[0].public_route_table_ids, null),
    try(module.gcp[0].public_route_table_ids, null),
    try(module.selfhosted[0].public_route_table_ids, null)
  )
}

output "private_route_table_ids" {
  value = coalesce(
    try(module.aws[0].private_route_table_ids, null),
    try(module.azure[0].private_route_table_ids, null),
    try(module.gcp[0].private_route_table_ids, null),
    try(module.selfhosted[0].private_route_table_ids, null)
  )
}

output "data_route_table_ids" {
  value = coalesce(
    try(module.aws[0].data_route_table_ids, null),
    try(module.azure[0].data_route_table_ids, null),
    try(module.gcp[0].data_route_table_ids, null),
    try(module.selfhosted[0].data_route_table_ids, null)
  )
}
